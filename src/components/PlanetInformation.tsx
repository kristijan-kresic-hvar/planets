...
const InformationBox = ({
  ...
  return (
    ...
    >
      <p className="text-opacity-50 mt-[0.44rem] md:mt-0 font-bold text-white uppercase font-spartan text-[0.5rem] lg:text-[0.6875rem] mb-[0.25rem] whitespace-nowrap">
        {title}
      </p>
      <span className="block text-white leading-normal tracking-[-0.04688rem] md:tracking-[-0.05625rem] lg:tracking-[-0.09375rem] font-antonio text-[1.25rem] md:text-[1.5rem] lg:text-[2.5rem] whitespace-nowrap my-[0.56rem] md:mb-[1.19rem] lg:mb-[1.69rem]">
        {value}
      </span>
    </div>
  );
